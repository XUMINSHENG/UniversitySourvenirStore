...
public class CustomerMgr {
	...
	public CustomerMgr() throws IOException,DataFileException {
	...
	/**public void writeToFile(ArrayList<Member> mem) {
		try {
	...
	public void readFromFile() {
		try {
			...
			ArrayList<Member> mem = (ArrayList<Member>) oi.readObject();
